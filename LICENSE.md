...
- 3.2. The Licensee SHALL:
  ...
  - 3.2.2. Allow for reasonable limitation of working hours and periodic holidays with pay
...
No additional modules from the Hippocratic License 3.0 builder (military, law enforcement, mass surveillance, copyleft, etc.) are included — this is the base license text only.
